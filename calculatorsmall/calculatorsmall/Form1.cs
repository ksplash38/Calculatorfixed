...
namespace calculatorsmall
{
    public partial class Form1 : Form
    {
        ...
        string strFNumber;
        decimal dcAnswer;
        public static double result = 0, value = 0, THBUSD = 30.3;
        ...
        private void button21_Click(object sender, EventArgs e)
        {
            ...
            //PreviousValue = double.Parse(textBox1.Text) / 100 * PreviousValue;
            //PreviousValue = PreviousValue - (double.Parse(textBox1.Text) / 100 * PreviousValue) ;
               if (textBox1.Text.Length <= 0)
            {

            }else { 

            textBox1.Text = (( double.Parse(textBox1.Text) / 100 * PreviousValue)).ToString();
            }
        }
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            ...
            // This method also works thats why am using it
            textBox2.Text = textBox2.Text + " * ";
            if (!FirstTime)
            {
        ...
        {
          //  listBox1.load = listBox1.Text + " Exp ";
        }
        ...
        {
            if (textBox1.Text.Length > 0 && listBoxCurrency.SelectedIndex > -1)
            {
                //get the task
                String currencyText = listBoxCurrency.SelectedItem.ToString();
                // do the task
                if (currencyText.Equals("THB -> USD"))
                {

                    // convert and round up to 3 decimal places
                    PreviousValue = double.Parse(textBox1.Text) / THBUSD;
                    textBox1.Text = PreviousValue.ToString(("N3"));
                    History.Items.Add(textBox2.Text + " THB -> USD " + THBUSD + " = " + textBox1.Text + "USD");
                    // textBox1.Text = ((double.Parse(textBox1.Text) / THBUSD)).ToString() + "USD";


                }
                else if
                     (currencyText.Equals("USD -> THB"))
                {
                    //  PreviousValue = double.Parse(textBox1.Text) * THBUSD;

                    textBox1.Text = ((double.Parse(textBox1.Text) * THBUSD)).ToString() + "THB";
                    History.Items.Add(textBox2.Text + " USD -> THB " + THBUSD + " = " + textBox1.Text);
                }
